...
What is the role of economic activity in inflation in recent quarters? And about external factors, have they played a significant role in the overall result? It's a common practice to quantify the contribution of each variable to the observed value in a given period. This type of decomposition is obtained by multiplying the value of each variable in the period by the respective model coefficient.
